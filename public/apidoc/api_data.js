define({ "api": [
  ...
  },
  {
    ...
    "filename": "./TaskController.php",
    "groupTitle": "任务管理",
    "name": "PostApiTasksAddtaskcarlist"
  },
  {
    "type": "post",
  ...
  },
  {
    ...
    "filename": "./TaskController.php",
    "groupTitle": "任务管理",
    "name": "PostApiTasksAddtaskmanlist"
  },
  {
    "type": "post",
  ...
  },
  {
    ...
    "filename": "./ReportController.php",
    "groupTitle": "报表管理",
    "name": "GetApiReportCar"
  },
  {
    "type": "get",
    "url": "/api/report/carlist",
    "title": "5.车辆出勤统计",
    "group": "报表管理",
    "header": {
      "examples": [
    ...
    "filename": "./ReportController.php",
    "groupTitle": "报表管理",
    "name": "GetApiReportCarlist"
  },
  {
    "type": "get",
    "url": "/api/report/objecttype",
    "title": "60.获取可选的收支对象类型",
    "group": "报表管理",
    "header": {
      "examples": [
        {
          "title": "简要说明",
          "content": "1、路由名称 report.objecttype\n2、不要任何参数，用于接口6使用",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "title": "801.临时员工所选时间段内的待结算明细",
    "group": "财务管理",
    "description": "<p>路由名称 accounts.getAccountUser</p> <p>返回值为一个对象（员工信息）两个数组，一个是出勤记录，一个是奖惩激励</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "accountID",
            "description": "<p>结算编号，最小值1，该接口只用于预览和打印</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/api/accounts/getFixedUser",
    "title": "802.固定员工所选时间段内的待结算明细",
    "group": "财务管理",
    "description": "<p>路由名称 accounts.getFixedUser</p> <p>返回值为一个对象（员工信息）两个数组，一个是出勤记录，一个是奖惩激励</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "./AccountController.php",
    "groupTitle": "财务管理",
    "name": "GetApiAccountsGetfixeduser"
  },
  {
    "type": "get",
