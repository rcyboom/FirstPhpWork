define({ "api": [
  ...
  },
  {
    ...
    "filename": "./CustomerController.php",
    "groupTitle": "客户管理",
    "name": "PostApiLinkmansId"
  },
  {
    "type": "post",
    "url": "/api/linkmans/list",
    "title": "53.获取某一个客户端联系人列表",
    "group": "客户管理",
    "success": {
      "examples": [
        {
          "title": "简要说明",
          "content": "路由名称 linkmans.list\nHTTP/1.1 200 OK\ncustomer_id 整数，客户ID",
          "type": "json"
        }
      ]
    },
    ...
    "filename": "./CustomerController.php",
    "groupTitle": "客户管理",
    "name": "PostApiLinkmansList"
  },
  {
    "type": "post",
    "url": "/api/linkmans/save",
    "title": "52.新建或者更新联系人",
    "group": "客户管理",
    "success": {
      "examples": [
